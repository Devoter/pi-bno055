...
extern int set_mode(loglevel_t, int, opmode_t);             // set the sensor ops mode
extern int get_calstatus(loglevel_t, int, struct bnocal*);  // read calibration status
extern int get_caloffset(loglevel_t, int, struct bnocal*);  // read calibration values
extern int get_power(loglevel_t, int, power_t*);            // get the sensor power mode
extern int set_power(loglevel_t, int, power_t);             // set the sensor power mode
extern int get_remap(loglevel_t, int, char, int*);          // get the axis remap values
extern int get_inf(loglevel_t, int, struct bnoinf*);        // read sensor information
extern int get_acc(loglevel_t, int, struct bnoacc*);        // read accelerometer data
extern int get_mag(loglevel_t, int, struct bnomag*);        // read magnetometer data
extern int get_gyr(loglevel_t, int, struct bnogyr*);        // read gyroscope data
extern int get_eul(loglevel_t, int, struct bnoeul*);        // read euler orientation
extern int get_qua(loglevel_t, int, struct bnoqua*);        // read quaternation data
extern int get_gra(loglevel_t, int, struct bnogra*);        // read gravity data
extern int get_lin(loglevel_t, int, struct bnolin*);        // read linar acceleration data
extern int get_clksrc(loglevel_t, int, int*);               // get the clock source setting
extern int get_sstat(loglevel_t, int, int*);                // get system status code
extern int bno_dump(loglevel_t, int);                       // dump the register map data
extern int bno_reset(loglevel_t, int);                      // reset the sensor
extern int load_cal(loglevel_t, int, char*);                // load calibration from file
extern int save_cal(loglevel_t, int, char*);                // write calibration to file
extern int get_acc_conf(loglevel_t, int, struct bnoaconf*); // get accelerometer config
extern int get_mag_conf(loglevel_t, int, struct bnomconf*); // get magnetometer config
extern int get_gyr_conf(loglevel_t, int, struct bnogconf*); // get gyroscope config
extern int set_acc_conf(loglevel_t, int);                   // set accelerometer config
extern int set_mag_conf(loglevel_t, int);                   // set magnetometer config
extern int set_gyr_conf(loglevel_t, int);                   // set gyroscope config
